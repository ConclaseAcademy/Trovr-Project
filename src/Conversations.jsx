...
const ProductCard = ({ listing }) => (
  <div style={styles.productCard}>
    ...
    <div style={styles.productDetails}>
      <div style={styles.productTitle}>{listing?.title || "Organic Chemistry Textbook - 2nd Edition"}</div>
      <div style={styles.productPrice}>荒{listing?.price || "5,000"}</div>
...
const styles = {
  container: { display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '10px', backgroundColor: '#f1f1f1' },
  ...
  top: { padding: '12px', borderBottom: '1px solid #eee', backgroundColor: '#fff' },
  ...
  avatar: { width: '36px', height: '36px', borderRadius: '50%', backgroundColor: '#f4c430', flexShrink: 0 },
  sellerName: { fontSize: '14px', fontWeight: 'bold', color: '#333' },
  itemSubtext: { fontSize: '11px', color: '#777' },
  ...
  productTitle: { fontSize: '12px', color: '#333' },
  ...
  bubble: { maxWidth: '80%', padding: '10px 14px', fontSize: '13px', lineHeight: '1.4', wordBreak: 'break-word' },
  ...
  inputField: { flexGrow: 1, padding: '10px 14px', borderRadius: '24px', border: '1px solid #e0e0e0', backgroundColor: '#f9f9f9', outline: 'none', fontSize: '13px' },
  sendBtn: { backgroundColor: '#d4af37', color: '#fff', border: 'none', borderRadius: '50%', width: '36px', height: '36px', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', fontSize: '14px' }
};
